...
<!--
File: Drivers/newsdata.md
-->

Search news articles from [newsdata.io](https://newsdata.io/).
...
The `weather` method has a default parameter called `q`, which is the "query"
